...
// starts at index 2, and deletes next three elements and then adds 777,888,999 
console.log("***** TO SPLICE METHOD ******");
levels.splice(2, 3, 777, 888, 999);
// Here the splice method will remove the three element starting at index 2 and add the following elements f
marks.splice(2, 3, 56, 65);
console.log(levels.toString()); // Prints a comma separated array 
console.log(marks.toString());
